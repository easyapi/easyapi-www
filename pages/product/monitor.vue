...
<head>
  ...
  <title>EasyAPI接口监控系统 - EasyAPI服务平台</title>
...
<style>
  ...
  .bug_btn:hover {
    color: rgb(48, 166, 215, 0.7);
  }

  .bug_btn:active {
    color: rgb(48, 166, 215, 0.6);
  }
  ...
  .u-banner-bg {
    background-image: url('../../static/images/product/bg_monitor.png');
    background-size: cover;
    height: 520px;
  }

  .u-banner-bg .sysinfo h1 {
    margin-bottom: 29px;
  }
</style>
