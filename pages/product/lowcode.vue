  ...
  <div class="low-code">
    <div class="banner">
      <div class="title">
        ...
        <el-button class="mg-t-10" size="large">
          立即体验
        </el-button>
      </div>
    </div>
      ...
      <div class="content">
        <div>
          ...
          <div class="flex justify-between">
            <div class="low-code-box-item bg-white">
    ...
    <div class="low-code-box">
      <div class="content">
        ...
        <div class="flex justify-between">
          <div class="low-code-box-index bg-white">
            <img src="https://qiniu.easyapi.com/EasyToUse.png">
            <h2 class="mx-12">
              简单易用
            </h2>
            <p class="mx-12">
              聚焦业务逻辑开发，无需关心服务器购买、服务部署、后期运维等操作
            </p>
          </div>
          <div class="low-code-box-index bg-white">
