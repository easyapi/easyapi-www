    ...
    <div class="navs f-fl">
      ...
      <span class="f-rel">私有化
          <div class="dis_show">
            <img class="down_img" src="/static/images/info/narrow.png">
            <ul class="isShow">
              <a href="/pages/solutionlution/portal.html" class="a_link">
                <li>
              ...
              <a href="/pages/solutionlution/market.html" class="a_link">
                <li>
              ...
              <a href="/pages/solutionlution/open.html" class="a_link">
                <li>
...
<div class="u-infobox" style="padding-bottom: 0">
  ...
  <div class="u-igateway f-cb">
    ...
    <div class="text f-fl" style="margin-top: 0px;">
      ...
      <p><img style="width: 6px;height: 6px;" src="../../static/images/info/market_tag.png">实现API服务分类浏览，API服务搜索<br>
