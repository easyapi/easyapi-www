...
useHead({
  ...
  meta: [{ name: 'description', content: 'API服务市场' },
    { name: 'keyword', content: 'API服务市场' }],
})
</script>
<template>
  <div>
    <div class="u-banner-bg">
      <div class="content">
        <div class="sysinfo f-tac">
          ...
          <a href="/info/contact" class="bug_btn">立刻部署API服务市场</a>
          <div class="more">独立第三方API服务市场解决方案提供商</div>
        </div>
      </div>
    </div>
...
.u-banner-bg {
  background-image: url('/images/solution/bg_market.png');
  height: 520px;
