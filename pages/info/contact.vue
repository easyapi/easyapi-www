...
<head>
  ...
  <style>
    ...
    .link_list .code .code_img img {
      width: 114px;
      height: 114px;
      float: left;
    }

    .link_list .code .code_img .line {
      width: 2px;
      height: 100px;
    ...
    .link_list .code .link_infr {
      clear: both;
      margin-top: 10px;
      text-align: left;
    }

    .link_list .code .link_infr span {
      margin-left: 18px;
    }
  ...
  <div class="u-contact">
    <div class="x-wp">
      <div class="tex ">
        ...
        <p>地址:无锡市滨湖区滴翠路100号创意产业园4号楼302</p>
      ...
      <div class="cerwm" style="padding-bottom: 45px;">
        <div class="hd">
          <a class="active" style="color: black;">添加联络人微信</a>
        </div>
...
<script type="text/javascript" src="https://api.map.baidu.com/api?v=3.0&ak=S6mqljAtjGZzvmeVxrRR68rA"></script>
