  ...
  <div class="about">
    ...
    <div class="about-box bg-f5">
      ...
      <div class="description f-c-white f-c-gray content">
        EasyAPI最初是我们团队内部的工具，因为热爱，我们希望她能得到更多的人来使用，我们也会一直站在她的旁边优化她，完美她，希望广大的苦B开发人员， 希望广大的苦B
        的开发人员，程序员早日用上，致力于数十万移
        <br />
        动开发者,后端的开发人员提供全套的API系统解决方案（发布，测试，浏览，监控）
      </div>
    </div>
    ...
    <div class="about-box">
      ...
      <div class="description content">
        ...
        <br />
        程序猿早日用上，致力于为数十万移动开发者，后端开发人员提供全套的API系统解决方案（发布、浏览、测试、监控、网关、接口服务）。
      </div>
    </div>
  </div>
</template>
