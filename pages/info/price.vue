...
<div class="u-infobox-price f-border-b">
  <ul class="u-price">
    ...
    <li class="">
      ...
      <!-- <a href="https://monitor.easyapi.com" class="free_use">免费试用</a> -->
    </li>
    <li>
...
<div class="u-infobox  f-border-b" style="background: #f5f5f5;">
  <div class="u-title">他们都在选我们</div>
  <div class="u-inro">API管理门户主要为开发企业搭建 API 门户，核心功能包括 API 文档管理、API 测试工具、API 监控系统等服务
