...
.card-bg {
  background: url(/images/info/bg_github.png) no-repeat center !important;
...
.github-content > ul > li {
  width: 200px;
  text-align: center;
  display: block;
}

.github-content > ul > li > span {
...
@media screen and (min-width: 1000px) {
  ...
  .bg_button {
    ...
    border-bottom: 4px solid #bf9f43;
    position: relative;
