  ...
  <client-only>
    <div v-if="ifShow" :style="headerActive" class="header header-index">
      <div class="content">
        ...
        <div class="navs f-fl">
          <el-popover @show="showProduct" @hide="hideProduct" placement="bottom-start" width="650" trigger="hover">
            <ul class="popover-ul">
          ...
          <el-popover @show="showPrivatization" @hide="hidePrivatization" placement="bottom-start" width="650" trigger="hover">
            <ul class="popover-ul">
        ...
        <div class="side-navs">
          <a v-if="!authenticationToken" class="register" href="https://account.easyapi.com/signup/" id="register">注册</a>
          <a v-if="!authenticationToken" class="login" href="https://account.easyapi.com/login/" id="login">登录</a>
